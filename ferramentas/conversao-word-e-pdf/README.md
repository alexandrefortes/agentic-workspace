...
2026-01-24 14:31:22 | usuario@empresa.com | md_para_pdf.py | documento.md → documento.pdf | SUCESSO
```
...
# Converter para PDF
python md_para_pdf.py contrato-cliente-x.md
...
python md_para_pdf.py relatorio-auditoria-q1.md
