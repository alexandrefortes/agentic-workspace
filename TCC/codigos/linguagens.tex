...
% Definindo um estilo global
\lstset{
    numbers=left,                       % Números de linha à esquerda
    numberstyle=\tiny\color{darkgray},      % Estilo dos números de linha
    breaklines=true,                    % Quebra automática de linhas
    frame=single,                       % Caixa ao redor do código
    aboveskip=12pt,                     % Espaçamento antes da caixa de código
    belowskip=12pt,                      % Espaçamento depois da caixa de código
    belowcaptionskip=12pt, % Espaço entre a legenda e o bloco de código
    abovecaptionskip=12pt, % Espaço entre o código e a legenda
    captionpos=b, % Legenda abaixo do código (b=bottom, t=top)
    xleftmargin=0.6cm, 
}