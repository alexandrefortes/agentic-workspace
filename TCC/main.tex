...
\includepdf[pages={-}, fitpaper=true]{elementos-pretextuais/Ficha_Alexandre.pdf}
...
% Inserindo o PDF sem alterar o conteúdo e sem margem (essa merda não funciona pra pdfs assinados digitalmente)
%\includepdf[pages=-, noautoscale=true, frame=false, offset=0mm 0mm]{elementos-pretextuais/Folha_de_Aprovacao_assinado_assinado_assinado.pdf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{elementos-textuais/capitulo-1-introdução.tex}
\input{elementos-textuais/capitulo-2-revisao-literatura.tex}
\input{elementos-textuais/capitulo-3-metodologia.tex}
\input{elementos-textuais/capitulo-4-resultados.tex}
\input{elementos-textuais/capitulo-5-conclusao.tex}
%\input{elementos-textuais/capitulo-objetivo.tex}
%\input{elementos-textuais/capitulo-recursos.tex}
%\input{elementos-textuais/capitulo-cronograma.tex}
